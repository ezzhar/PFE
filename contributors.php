<?php 
  ...
  $collaborateurs = Collaborateurs::getAllCollaborateur();
        ...
        <!-- navbare -->
          ...
          <header class="site-navbar" role="banner">
            ...
            <div class="image-pages">
                ...
                <img src="images/contributors/cont.jpg">
                <h1>المساهمين</h1>
            </div>
        <!-- /navbare -->
                    ...
                    <?php foreach ($collaborateurs as $collaborateur): ?>
                      <div class="card">
                        <div class="content">
                          ...
                          <div class="details">
                            <div class="name"><?php echo substr($collaborateur['NOM_COLLAB'], 0, 50); ?></div>
                            <div class="job" style="direction: rtl;"><?php echo substr($collaborateur['DEFINITION_COLLAB'], 0, 80) . " . . ."; ?></div>
